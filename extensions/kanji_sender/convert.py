# Original work: https://github.com/aleckretch/Romaji-to-Japanese-Converter/blob/master/convert.py
...
def romajiToJapanese(romaji: str, use_hiragana=True):
	romaji = romaji.lower()
	currentAlphabet = hiragana if use_hiragana else katakana
