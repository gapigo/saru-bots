...
#browser_path = path.join(Path(__file__).parent.parent.parent.absolute(), f'chromedriver'))
#browser_path = path.join(Path(__file__).parent.parent.parent.absolute(), f'chromedriver')
#hti.browser = driver
hti.browser_executable = "/usr/bin/chromedriver"
# print(browser_path)
#hti.browser_executable = browser_path
...
def  search_on_romajidesu(searched_kanji: str) -> dict:
    ...
    image = hti.screenshot(
        ...
        #html_file=html_path, save_as='romajidesu.png'
        #url='https://www.python.org', save_as='screenshot.png'
    )
    png_path = path.join(Path(__file__).parent.absolute(), f'images/romajidesu.png')
    # print('PINTO')
    # print(image[0])
